...
public class BipartitionDetection{
    ...
    public static void main(String[] args){
        Graph g = new Graph("04-Graph-DFS-Applications/11-Bipartition-Detection/g.txt");
        BipartitionDetection bipartitionDetection = new BipartitionDetection(g);
        System.out.println(bipartitionDetection.isBipartite());
        // true


        Graph g2 = new Graph("04-Graph-DFS-Applications/11-Bipartition-Detection/g2.txt");
        ...
        Graph g3 = new Graph("04-Graph-DFS-Applications/11-Bipartition-Detection/g3.txt");
